...
use class IUHub:Eui {
  ...
  new() self {
   ...
   hideNShowResponse(Set toShow) {
    List allElems =@ Lists.from("logindiv", "actionLinksDiv", "devLinksListDiv", "devLinksDiv", "passchangediv", "sessionsDiv", "devicelogindiv", "remoteaccessdiv", "browseFilesDiv", "accountdiv", "backupdiv", "setupDiv", "appsDiv", "aboutDiv");
   ...
   initialSetup() {
     ...
     HC.callApp(Lists.from("initialSetupRequest", setupToken, HD.getElementById("setupAccountName").value, HD.getElementById("setupAccountPass").value, HD.getElementById("setupDeviceName").value, HD.getElementById("setupKonnLogin").value, HD.getElementById("setupKonnPass").value, HD.getElementById("setupLE").checked, HD.getElementById("setupCam").checked));
