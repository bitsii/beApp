...
java -classpath ..\abe-pl\target5\BEL_system_be_jv.jar;..\abe-pl\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\shared.txt --deployPath ..\apprun\App\Bex\d --buildPath ..\apprun\App\Bex --emitLang jv -mainClass=App:BrowserExample --emitFlag foo source\Bex.be source\BrowserUI.be source\BrowserJvFx.be source\App.be

javac ..\abe-pl\system\jv\be\BELS_Base\*.java ..\apprun\App\Bex\Base\target\jv\be\BEL_4_Base\*.java

java -classpath ..\abe-pl\target5\BEL_system_be_jv.jar;..\abe-pl\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\base.txt --deployPath ..\apprun\App\Bex\d --buildPath ..\apprun\App\Bex --emitLang js --ownProcess false -mainClass=App:BexBr source\BexBr.be source\BrowserEUI.be
