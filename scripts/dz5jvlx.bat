...
java -classpath ..\be\target5\BEL_system_be_jv.jar;..\be\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\base.txt --deployPath ..\apprun\App\Dz\d --buildPath ..\apprun\App\Dz --emitLang js --outputPlatform linux --ownProcess false -mainClass=Dz:Eui source\DzEui.be
