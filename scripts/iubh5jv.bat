...
java -classpath ..\abe-pl\target5\BEL_system_be_jv.jar;..\abe-pl\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base ../abe-pl/source/base/Uses.be --buildFile build\shared.txt --deployPath ..\apprun\App\IUHub\d --buildPath ..\apprun\App\IUHub --emitLang jv -mainClass=IUHub:BigHubStart source\IU.be source\IUHubTest.be source\IUHub.be source\IUCam.be source\IUBigHub.be source\Db.be source\BrowserUI.be source\BrowserJvFx.be source\WebServer.be source\App.be source\WebApp.be
...
java -classpath ..\abe-pl\target5\BEL_system_be_jv.jar;..\abe-pl\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base ../abe-pl/source/base/Uses.be --buildFile build\base.txt --deployPath ..\apprun\App\IUHub\d --buildPath ..\apprun\App\IUHub --emitLang js --ownProcess false -mainClass=IUHub:Eui ..\abe-pl\source\extended\Log.be source\IUHubBr.be source\BrowserEUI.be

if %errorlevel% neq 0 exit /b %errorlevel%

java -classpath ..\abe-pl\target5\BEL_system_be_jv.jar;..\abe-pl\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base ../abe-pl/source/base/Uses.be --buildFile build\base.txt --deployPath ..\apprun\App\IUCam\d --buildPath ..\apprun\App\IUCam --emitLang js --ownProcess false -mainClass=IUCam:Eui ..\abe-pl\source\extended\Log.be source\IUCamBr.be source\BrowserEUI.be
