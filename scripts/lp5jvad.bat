...
java -classpath ..\be\target5\BEL_system_be_jv.jar;..\be\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\shared.txt --deployPath ..\apprun\App\LocPing\d --buildPath ..\apprun\App\LocPing --emitLang jv --outputPlatform linux --emitFlag platDroid -mainClass=App:LocPing source\LocPing.be source\BrowserUI.be
