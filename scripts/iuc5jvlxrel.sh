...
mono --debug ../abelii/target5/BEX_E_mcs.exe ../abelii/source/base/Uses.be --buildFile build/base.txt --deployPath ../apprun/App/IUCam/d --buildPath ../apprun/App/IUCam --emitLang js --outputPlatform linux --ownProcess false -mainClass=IUCam:Eui ../abelii/source/extended/Log.be source/IUCamBr.be source/BrowserEUI.be
