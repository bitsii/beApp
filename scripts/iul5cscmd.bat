...
..\be\target5\BEL_4_Base_csc.exe ../be/source/base/Uses.be --buildFile build\shared.txt --deployPath ..\apprun\App\IULink\d --buildPath ..\apprun\App\IULink --emitLang cs -mainClass=App:IULink --emitFlag foo source\IULink.be source\BrowserUI.be source\BrowserCsWf.be source\App.be source\Db.be 
