...
java -classpath ..\be\target5\BEL_system_be_jv.jar;..\be\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\shared.txt --deployPath ..\apprun\App\IULink\d --buildPath ..\apprun\App\IULink --emitLang jv --outputPlatform linux --emitFlag platDroid -mainClass=App:IULink source\IULink.be source\BrowserUI.be source\App.be source\BrowserJvAd.be source\Db.be
