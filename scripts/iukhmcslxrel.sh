...
mono --debug ../abe-pl/target5/BEX_E_mcs.exe ../abe-pl/source/base/Uses.be --buildFile build/shared.txt --deployPath deployKh --buildPath targetKh --emitLang cs --outputPlatform linux -mainClass=Konnectii:Host ../abe-pl/source/extended/Log.be source/IUKH.be
