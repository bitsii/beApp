...
javac -classpath extlibs\jetty\*;extlibs\bcastlejv\* ..\be\system\jv\be\BELS_Base\*.java ..\apprun\App\LocPing\Base\target\jv\be\BEL_4_Base\*.java

java -classpath ..\be\target5\BEL_system_be_jv.jar;..\be\target5\BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build\base.txt --deployPath ..\apprun\App\LocPing\d --buildPath ..\apprun\App\LocPing --emitLang js --ownProcess false -mainClass=App:LocPing:LPBr source\LocPingBr.be
...
copy /y extlibs\jetty\* ..\apprun\App\LocPing
copy /y extlibs\bcastlejv\* ..\apprun\App\LocPing
