...
java -classpath ../abe-pl/target5/BEL_system_be_jv.jar:../abe-pl/target5/BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build/shared.txt --deployPath ../apprun/App/IUHubd --buildPath ../apprun/App/IUHub --emitLang jv -mainClass=IUHub:HubStart source/IUHubTest.be source/IUHub.be source/Db.be source/BrowserUI.be source/BrowserJvFx.be source/WebServer.be source/App.be
...
java -classpath ../abe-pl/target5/BEL_system_be_jv.jar:../abe-pl/target5/BEL_4_Base_be_jv.jar be.BEL_4_Base.BEL_4_Base --buildFile build/base.txt --deployPath ../apprun/App/IUHubd --buildPath ../apprun/App/IUHub --emitLang js --ownProcess false -mainClass=IUHub:Eui source/IUHubBr.be source/BrowserEUI.be
