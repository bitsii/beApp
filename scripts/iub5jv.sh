...
java be.BEX_E ../abe-pl/source/base/Uses.be --buildFile build/shared.txt --deployPath ../apprun/App/IUHub/d --buildPath ../apprun/App/IUHub --emitLang jv --emitFlag iuDebug --emitFlag iuCamBridge --emitFlag iuOwnBackground -mainClass=IUBridge:CamBridgeStart ../abe-pl/source/extended/Log.be source/IU.be source/IUHub.be source/IUCam.be source/IUBridge.be source/IUCamBridge.be source/Db.be source/SlDbJv.be source/BrowserUI.be source/BrowserJvFx.be source/WebServer.be source/App.be source/WebApp.be
